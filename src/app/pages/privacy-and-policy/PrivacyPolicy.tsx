...
function PrivacyPolicy() {
  return (
    <Containers>
      ...
      <Typography>Last updated: February 01, 2024</Typography>
      <br />
      <Typography>
      ...
      <ul>
        ...
        <li>
          <strong>Application</strong> refers to vShare application, the
        ...
        <li>
          ...
          this Agreement) refers to Sabaiydev Technology Sole co.,Ltd, Nongnieng
          village, Xaisettha distrist, Vientiane, Lao PDR.
          <br />
        ...
        <li>
          <strong>Website</strong> refers to vShare, accessible from{" "}
          <a
            href="https://www.vshare.net/"
      ...
      <ul>
        ...
        <li>Phone number</li>
        <li>Image profile from social account (social login)</li>
        <li>Address, State, Province, ZIP/Postal code, City, Country</li>
        <li>Order information (order ID, payment method, item ID)</li>
        <li>Usage Data</li>
      </ul>
      <Typography>
      ...
      <ul>
        <li>
          Address, State, Province, ZIP/Postal code, City and Country (in case
          of pay with card)
        </li>
      </ul>
      <h4>Usage Data</h4>
      ...
      <ul>
        ...
        <li>Device UUID (in case of login)</li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          <br />
          You can opt-out from AdColony service by visiting the AdColony Opt-out
          page:{" "}
          <a
        ...
        <li>
          ...
          information to provide, operate, and improve Unity Technologies
          ...
          .<br />
          You can prevent Unity Ads from using your information by opting-out.
      ...
      <br />
      <Typography>The third-party vendors We use are:</Typography>
      <br />
      <ul>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          vendors to provide advertising on our Service, third-party vendors to
      ...
      <ul>
        <li>
          ...
          <a
            href="https://www.vshare.net/contact-us"
            rel="external nofollow noopener"
            target="_blank"
          >
            Contact
      ...
      <Typography>Your request to Us must:</Typography>
      <ul>
        <li>
      ...
      <ul>
        <li>
          <strong>Location</strong> NongNieng village, Saysettha district and
          Vientiane Capital.
        </li>
        <li>
          <strong>Tel</strong> +856 21755789
        </li>
        <li>
          <strong>Email</strong> support@vshare.net
        </li>
        <li>
          By visiting this page on our website:{" "}
          <a
