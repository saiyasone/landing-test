    ...
    <Containers>
      ...
      <ul>
        <li>
          ...
          the Company downloaded by You on any electronic device, named vShare
          moblie app
        </li>
        <li>
        ...
        <li>
          ...
          village, xaysetha district, vientaine, Lao PDR.
        </li>
        <li>
        ...
        <li>
          <strong>In-app Purchase</strong> refers to the purchase of a product,
          item, service or Subscription made through the Application and subject
          to these Terms and Conditions and/or the Application Store's own terms
          and conditions.
        </li>
        <li>
      ...
      <Typography>
        ...
        <a href="mailto:dmca@vshare.net">dmca@vshare.net</a> and include in Your
      ...
      <Typography>
        ...
        <a href="mailto:dmca@vshare.net">dmca@vshare.net</a>. Upon receipt of a
      ...
      <ul>
        <li>
          <Typography>By email: support@vshare.net</Typography>
        </li>
        <li>
          <Typography>
